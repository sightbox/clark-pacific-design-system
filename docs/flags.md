...
6. **Mobile Footer and Brand Sign-off.** Pages use the condensed mobile components, so desktop-only footer lines and the sign-off body copy don't appear on mobile.
